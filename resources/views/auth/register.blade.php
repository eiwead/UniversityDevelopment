            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="wage" class="col-md-4 col-form-label text-md-end">{{ __('Wage') }}</label>

                            <div class="col-md-6">
                                <input id="wage" type="text" class="form-control @error('wage') is-invalid @enderror" name="wage" value="{{ old('wage') }}" required autocomplete="wage" autofocus>
